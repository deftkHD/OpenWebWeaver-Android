...
class AccountAdapter(context: Context, elements: List<Account>, private val loginViewModel: LoginViewModel): ArrayAdapter<Account>(context, 0, elements) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (item.name == loginViewModel.apiContext.value?.user?.login) {
