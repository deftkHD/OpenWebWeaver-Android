...
class ForumAdapter(context: Context, elements: List<Member>): ArrayAdapter<Member>(context, 0, elements) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        listItemView.findViewById<TextView>(R.id.forum_name).text = item.name ?: item.login
        return listItemView
    }
