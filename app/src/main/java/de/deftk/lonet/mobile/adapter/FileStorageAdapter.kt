...
class FileStorageAdapter(context: Context, val elements: Map<Group, Quota>) : ArrayAdapter<Group>(context, 0, elements.keys.toList()) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        imageView.setImageResource(R.drawable.ic_folder_dark_24)
