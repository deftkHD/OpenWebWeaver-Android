...
class MailFolderAdapter(context: Context, elements: List<EmailFolder>) :
    ...
    companion object {
        ...
        private val folderImages = mapOf(
            Pair(EmailFolder.EmailFolderType.INBOX, R.drawable.ic_email_folder_inbox),
            Pair(EmailFolder.EmailFolderType.DRAFTS, R.drawable.ic_email_folder_drafts),
            Pair(EmailFolder.EmailFolderType.SENT, R.drawable.ic_email_folder_sent),
            Pair(EmailFolder.EmailFolderType.TRASH, R.drawable.ic_email_folder_trash)
        )
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        listItemView.findViewById<ImageView>(R.id.mail_folder_image)
            .setImageResource(folderImages[item.type] ?: R.drawable.ic_email_folder_default)
        return listItemView
    }
